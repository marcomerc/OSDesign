...
80100a12:	81 c4 1c 01 00 00    	add    $0x11c,%esp
80100a18:	5b                   	pop    %ebx
80100a19:	5e                   	pop    %esi
80100a1a:	5f                   	pop    %edi
80100a1b:	5d                   	pop    %ebp
...
80100b7e:	e8 dd 5d 00 00       	call   80106960 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100b88:	e9 85 fe ff ff       	jmp    80100a12 <exec+0x72>
  ...
  if((ip = namei(path)) == 0){
    end_op();
80100b8d:	e8 ee 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b92:	c7 04 24 81 6f 10 80 	movl   $0x80106f81,(%esp)
...
80100ba8:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100bae:	c7 44 24 04 00 e0 ff 	movl   $0xffffe000,0x4(%esp)
80100bb5:	ff 
80100bb6:	89 04 24             	mov    %eax,(%esp)
80100bb9:	e8 d2 5e 00 00       	call   80106a90 <clearpteu>
  sp = sz;
...
80100bc5:	0f 84 5d 01 00 00    	je     80100d28 <exec+0x388>
80100bcb:	8b 7d 0c             	mov    0xc(%ebp),%edi
80100bce:	31 f6                	xor    %esi,%esi
80100bd0:	31 db                	xor    %ebx,%ebx
80100bd2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100bd5:	89 f2                	mov    %esi,%edx
80100bd7:	89 fe                	mov    %edi,%esi
80100bd9:	89 d7                	mov    %edx,%edi
80100bdb:	83 c1 04             	add    $0x4,%ecx
80100bde:	eb 08                	jmp    80100be8 <exec+0x248>
80100be0:	83 c1 04             	add    $0x4,%ecx
    if(argc >= MAXARG)
80100be3:	83 ff 20             	cmp    $0x20,%edi
80100be6:	74 8d                	je     80100b75 <exec+0x1d5>
      goto bad;
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100be8:	89 04 24             	mov    %eax,(%esp)
80100beb:	89 8d ec fe ff ff    	mov    %ecx,-0x114(%ebp)
...
80100c21:	e8 ca 5f 00 00       	call   80106bf0 <copyout>
80100c26:	85 c0                	test   %eax,%eax
80100c28:	0f 88 47 ff ff ff    	js     80100b75 <exec+0x1d5>
    goto bad;
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
  sp = sz;
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100c2e:	8b 8d ec fe ff ff    	mov    -0x114(%ebp),%ecx
    if(argc >= MAXARG)
      goto bad;
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
      goto bad;
    ustack[3+argc] = sp;
80100c34:	8d 95 58 ff ff ff    	lea    -0xa8(%ebp),%edx
...
80100c44:	8b 01                	mov    (%ecx),%eax
80100c46:	89 ce                	mov    %ecx,%esi
80100c48:	85 c0                	test   %eax,%eax
80100c4a:	75 94                	jne    80100be0 <exec+0x240>
80100c4c:	89 fe                	mov    %edi,%esi
  }
  ustack[3+argc] = 0;
...
80100c4e:	8d 04 b5 04 00 00 00 	lea    0x4(,%esi,4),%eax
80100c55:	89 d9                	mov    %ebx,%ecx
80100c57:	29 c1                	sub    %eax,%ecx
...
80100c68:	89 54 24 08          	mov    %edx,0x8(%esp)
80100c6c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  ...
  ustack[3+argc] = 0;
80100c70:	c7 84 b5 64 ff ff ff 	movl   $0x0,-0x9c(%ebp,%esi,4)
80100c77:	00 00 00 00 
  ustack[0] = 0xffffffff;  // fake return PC
  ustack[1] = argc;
  ustack[2] = sp - (argc+1)*4;  // argv pointer
...
80100c7b:	89 04 24             	mov    %eax,(%esp)
  ...
  ustack[0] = 0xffffffff;  // fake return PC
80100c7e:	c7 85 58 ff ff ff ff 	movl   $0xffffffff,-0xa8(%ebp)
80100c85:	ff ff ff 
  ustack[1] = argc;
80100c88:	89 b5 5c ff ff ff    	mov    %esi,-0xa4(%ebp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c8e:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)

  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c94:	e8 57 5f 00 00       	call   80106bf0 <copyout>
80100c99:	85 c0                	test   %eax,%eax
80100c9b:	0f 88 d4 fe ff ff    	js     80100b75 <exec+0x1d5>
    goto bad;
...
80100cdb:	83 c0 70             	add    $0x70,%eax
...
80100ce1:	e8 7a 37 00 00       	call   80104460 <safestrcpy>
  ...
  curproc->pgdir = pgdir;
80100ce6:	8b 8d f0 fe ff ff    	mov    -0x110(%ebp),%ecx
    if(*s == '/')
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
  ...
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
80100cec:	8b 77 08             	mov    0x8(%edi),%esi
  curproc->pgdir = pgdir;
  curproc->sz = sz;
80100cef:	c7 47 04 00 00 00 00 	movl   $0x0,0x4(%edi)
...
80100cf6:	8b 47 1c             	mov    0x1c(%edi),%eax
  ...
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
80100cf9:	89 4f 08             	mov    %ecx,0x8(%edi)
  curproc->sz = sz;
  curproc->tf->eip = elf.entry;  // main
80100cfc:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d02:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->st = TOPSTACK - PGSIZE;
  curproc->tf->esp = sp;
80100d05:	8b 47 1c             	mov    0x1c(%edi),%eax
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
  curproc->sz = sz;
  curproc->tf->eip = elf.entry;  // main
  curproc->st = TOPSTACK - PGSIZE;
80100d08:	c7 07 00 90 00 00    	movl   $0x9000,(%edi)
  curproc->tf->esp = sp;
80100d0e:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d11:	89 3c 24             	mov    %edi,(%esp)
80100d14:	e8 c7 58 00 00       	call   801065e0 <switchuvm>
  freevm(oldpgdir);
80100d19:	89 34 24             	mov    %esi,(%esp)
80100d1c:	e8 3f 5c 00 00       	call   80106960 <freevm>
  return 0;
...
80100d23:	e9 ea fc ff ff       	jmp    80100a12 <exec+0x72>
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100d28:	31 db                	xor    %ebx,%ebx
80100d2a:	31 f6                	xor    %esi,%esi
80100d2c:	8d 95 58 ff ff ff    	lea    -0xa8(%ebp),%edx
80100d32:	e9 17 ff ff ff       	jmp    80100c4e <exec+0x2ae>
...
80100d46:	c7 44 24 04 8d 6f 10 	movl   $0x80106f8d,0x4(%esp)
80100d4d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e07:	c7 04 24 94 6f 10 80 	movl   $0x80106f94,(%esp)
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ecc:	c7 04 24 9c 6f 10 80 	movl   $0x80106f9c,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  ...
  panic("fileread");
80100fb7:	c7 04 24 a6 6f 10 80 	movl   $0x80106fa6,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010d1:	c7 04 24 af 6f 10 80 	movl   $0x80106faf,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010dd:	c7 04 24 b5 6f 10 80 	movl   $0x80106fb5,(%esp)
...
80101195:	c7 04 24 bf 6f 10 80 	movl   $0x80106fbf,(%esp)
...
801012bc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012bd:	c7 04 24 d5 6f 10 80 	movl   $0x80106fd5,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101377:	c7 04 24 e5 6f 10 80 	movl   $0x80106fe5,(%esp)
...
80101458:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101459:	c7 04 24 f8 6f 10 80 	movl   $0x80106ff8,(%esp)
...
8010147c:	c7 44 24 04 0b 70 10 	movl   $0x8010700b,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 12 70 10 	movl   $0x80107012,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 78 70 10 80 	movl   $0x80107078,(%esp)
...
801015dc:	e9 2f fc ff ff       	jmp    80101210 <iget>
  ...
  panic("ialloc: no inodes");
801015e1:	c7 04 24 18 70 10 80 	movl   $0x80107018,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 30 70 10 80 	movl   $0x80107030,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101776:	c7 04 24 2a 70 10 80 	movl   $0x8010702a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017c3:	c7 04 24 3f 70 10 80 	movl   $0x8010703f,(%esp)
...
80101c61:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c62:	c7 04 24 59 70 10 80 	movl   $0x80107059,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 47 70 10 80 	movl   $0x80107047,(%esp)
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ee5:	c7 04 24 68 70 10 80 	movl   $0x80107068,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ef1:	c7 04 24 66 76 10 80 	movl   $0x80107666,(%esp)
...
80101fdf:	c7 04 24 d4 70 10 80 	movl   $0x801070d4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101feb:	c7 04 24 cb 70 10 80 	movl   $0x801070cb,(%esp)
...
80102006:	c7 44 24 04 e6 70 10 	movl   $0x801070e6,0x4(%esp)
8010200d:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021db:	c7 04 24 ea 70 10 80 	movl   $0x801070ea,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 15 71 10 80 	movl   $0x80107115,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021f3:	c7 04 24 00 71 10 80 	movl   $0x80107100,(%esp)
...
80102248:	c7 04 24 34 71 10 80 	movl   $0x80107134,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010237e:	c7 04 24 66 71 10 80 	movl   $0x80107166,(%esp)
...
801023eb:	c7 44 24 04 6c 71 10 	movl   $0x8010716c,0x4(%esp)
801023f2:	80 
...
80102534:	0f b6 81 a0 72 10 80 	movzbl -0x7fef8d60(%ecx),%eax
...
80102568:	0f b6 91 a0 72 10 80 	movzbl -0x7fef8d60(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 a0 71 10 80 	movzbl -0x7fef8e60(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010257f:	8b 04 85 80 71 10 80 	mov    -0x7fef8e80(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a7b:	c7 44 24 04 a0 73 10 	movl   $0x801073a0,0x4(%esp)
80102a82:	80 
...
80102ca2:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102ca3:	c7 04 24 a4 73 10 80 	movl   $0x801073a4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d60:	c7 04 24 b3 73 10 80 	movl   $0x801073b3,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d6c:	c7 04 24 c9 73 10 80 	movl   $0x801073c9,(%esp)
...
80102d97:	c7 04 24 e4 73 10 80 	movl   $0x801073e4,(%esp)
...
80102e13:	e8 58 3c 00 00       	call   80106a70 <kvmalloc>
...
80102e45:	e8 36 3e 00 00       	call   80106c80 <shminit>
  tvinit();        // trap vectors
80102e4a:	e8 11 26 00 00       	call   80105460 <tvinit>
80102e4f:	90                   	nop
  binit();         // buffer cache
...
80102f3f:	00 
80102f40:	c7 44 24 04 f8 73 10 	movl   $0x801073f8,0x4(%esp)
80102f47:	80 
...
80102ffa:	00 
80102ffb:	c7 44 24 04 fd 73 10 	movl   $0x801073fd,0x4(%esp)
80103002:	80 
...
8010308c:	ff 24 8d 3c 74 10 80 	jmp    *-0x7fef8bc4(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 1c 74 10 80 	movl   $0x8010741c,(%esp)
...
801031df:	c7 44 24 04 50 74 10 	movl   $0x80107450,0x4(%esp)
801031e6:	80 
...
8010352d:	89 53 1c             	mov    %edx,0x1c(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 55 54 10 80 	movl   $0x80105455,0x14(%eax)
...
801035e6:	c7 44 24 04 55 74 10 	movl   $0x80107455,0x4(%esp)
801035ed:	80 
...
80103658:	eb ea                	jmp    80103644 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010365a:	c7 04 24 5c 74 10 80 	movl   $0x8010745c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 38 75 10 80 	movl   $0x80107538,(%esp)
...
801036e3:	e8 f8 32 00 00       	call   801069e0 <setupkvm>
...
80103705:	80 
80103706:	e8 e5 2f 00 00       	call   801066f0 <inituvm>
  p->sz = PGSIZE;
8010370b:	c7 43 04 00 10 00 00 	movl   $0x1000,0x4(%ebx)
...
80103728:	e8 53 0b 00 00       	call   80104280 <memset>
...
8010375e:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103765:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103768:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010376f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103772:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80103779:	8d 43 70             	lea    0x70(%ebx),%eax
8010377c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103783:	00 
80103784:	c7 44 24 04 85 74 10 	movl   $0x80107485,0x4(%esp)
8010378b:	80 
8010378c:	89 04 24             	mov    %eax,(%esp)
8010378f:	e8 cc 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
80103794:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
8010379b:	e8 60 e7 ff ff       	call   80101f00 <namei>
801037a0:	89 43 6c             	mov    %eax,0x6c(%ebx)
...
801037aa:	e8 91 09 00 00       	call   80104140 <acquire>

  p->state = RUNNABLE;
801037af:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)

  release(&ptable.lock);
801037b6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037bd:	e8 6e 0a 00 00       	call   80104230 <release>
}
...
801037c7:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037c8:	c7 04 24 6c 74 10 80 	movl   $0x8010746c,(%esp)
...
801037f3:	89 c3                	mov    %eax,%ebx
  ...
  sz = curproc->sz;
801037f5:	8b 40 04             	mov    0x4(%eax),%eax
  if(n > 0){
...
8010380a:	e8 31 30 00 00       	call   80106840 <allocuvm>
...
80103811:	74 35                	je     80103848 <growproc+0x68>
  ...
  curproc->sz = sz;
80103813:	89 43 04             	mov    %eax,0x4(%ebx)
  switchuvm(curproc);
80103816:	89 1c 24             	mov    %ebx,(%esp)
80103819:	e8 c2 2d 00 00       	call   801065e0 <switchuvm>
  return 0;
...
8010383a:	e8 01 31 00 00       	call   80106940 <deallocuvm>
...
80103874:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80103885:	e8 36 32 00 00       	call   80106ac0 <copyuvm>
...
8010388f:	0f 84 a8 00 00 00    	je     8010393d <fork+0xed>
  ...
  np->sz = curproc->sz;
80103895:	8b 43 04             	mov    0x4(%ebx),%eax
80103898:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010389b:	89 41 04             	mov    %eax,0x4(%ecx)
  np->parent = curproc;
  *np->tf = *curproc->tf;
8010389e:	8b 79 1c             	mov    0x1c(%ecx),%edi
801038a1:	89 c8                	mov    %ecx,%eax
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
  }
  np->sz = curproc->sz;
  np->parent = curproc;
801038a3:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
801038a6:	8b 73 1c             	mov    0x1c(%ebx),%esi
801038a9:	b9 13 00 00 00       	mov    $0x13,%ecx
801038ae:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;

  for(i = 0; i < NOFILE; i++)
801038b0:	31 f6                	xor    %esi,%esi
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
  ...
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801038b2:	8b 40 1c             	mov    0x1c(%eax),%eax
801038b5:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039b5:	e8 26 2c 00 00       	call   801065e0 <switchuvm>
      p->state = RUNNING;
...
801039cb:	e8 eb 0a 00 00       	call   801044bb <swtch>
      switchkvm();
801039d0:	e8 eb 2b 00 00       	call   801065c0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103a6d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a6e:	c7 04 24 90 74 10 80 	movl   $0x80107490,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a7a:	c7 04 24 bc 74 10 80 	movl   $0x801074bc,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a86:	c7 04 24 ae 74 10 80 	movl   $0x801074ae,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103a92:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 dd 74 10 80 	movl   $0x801074dd,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103ba7:	c7 04 24 d0 74 10 80 	movl   $0x801074d0,(%esp)
...
80103c8e:	c7 04 24 ef 74 10 80 	movl   $0x801074ef,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103c9a:	c7 04 24 e9 74 10 80 	movl   $0x801074e9,(%esp)
...
80103d38:	e8 23 2c 00 00       	call   80106960 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 7f 78 10 80 	movl   $0x8010787f,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103ead:	ba 00 75 10 80       	mov    $0x80107500,%edx
  uint pc[10];
...
80103eb4:	8b 14 85 60 75 10 80 	mov    -0x7fef8aa0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ebb:	b8 00 75 10 80       	mov    $0x80107500,%eax
...
80103ed0:	c7 04 24 04 75 10 80 	movl   $0x80107504,(%esp)
...
80103f19:	c7 04 24 41 6f 10 80 	movl   $0x80106f41,(%esp)
...
80103f4a:	c7 44 24 04 78 75 10 	movl   $0x80107578,0x4(%esp)
80103f51:	80 
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 83 75 10 80 	movl   $0x80107583,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010420a:	c7 04 24 a2 75 10 80 	movl   $0x801075a2,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104216:	c7 04 24 8b 75 10 80 	movl   $0x8010758b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104241:	c7 04 24 a9 75 10 80 	movl   $0x801075a9,(%esp)
...
801044d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801044da:	e8 c1 f1 ff ff       	call   801036a0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801044df:	8b 40 04             	mov    0x4(%eax),%eax
801044e2:	39 d8                	cmp    %ebx,%eax
801044e4:	76 1a                	jbe    80104500 <fetchint+0x30>
801044e6:	8d 53 04             	lea    0x4(%ebx),%edx
801044e9:	39 d0                	cmp    %edx,%eax
801044eb:	72 13                	jb     80104500 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
801044ed:	8b 45 0c             	mov    0xc(%ebp),%eax
801044f0:	8b 13                	mov    (%ebx),%edx
...
80104505:	eb ef                	jmp    801044f6 <fetchint+0x26>
...
8010451a:	e8 81 f1 ff ff       	call   801036a0 <myproc>
  ...
  if(addr >= curproc->sz)
8010451f:	39 58 04             	cmp    %ebx,0x4(%eax)
80104522:	76 28                	jbe    8010454c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104524:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104527:	89 da                	mov    %ebx,%edx
80104529:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010452b:	8b 40 04             	mov    0x4(%eax),%eax
  for(s = *pp; s < ep; s++){
8010452e:	39 c3                	cmp    %eax,%ebx
80104530:	73 1a                	jae    8010454c <fetchstr+0x3c>
    if(*s == 0)
80104532:	80 3b 00             	cmpb   $0x0,(%ebx)
80104535:	75 0e                	jne    80104545 <fetchstr+0x35>
80104537:	eb 1f                	jmp    80104558 <fetchstr+0x48>
80104539:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104540:	80 3a 00             	cmpb   $0x0,(%edx)
80104543:	74 13                	je     80104558 <fetchstr+0x48>
  ...
  *pp = (char*)addr;
  ep = (char*)curproc->sz;
  for(s = *pp; s < ep; s++){
80104545:	83 c2 01             	add    $0x1,%edx
80104548:	39 d0                	cmp    %edx,%eax
8010454a:	77 f4                	ja     80104540 <fetchstr+0x30>
    if(*s == 0)
      return s - *pp;
  }
  return -1;
}
8010454c:	83 c4 04             	add    $0x4,%esp
{
  char *s, *ep;
  struct proc *curproc = myproc();
...
8010457b:	e8 20 f1 ff ff       	call   801036a0 <myproc>
...
801045cf:	8b 46 04             	mov    0x4(%esi),%eax
801045d2:	39 c2                	cmp    %eax,%edx
801045d4:	73 1a                	jae    801045f0 <argptr+0x50>
801045d6:	01 d3                	add    %edx,%ebx
801045d8:	39 d8                	cmp    %ebx,%eax
801045da:	72 14                	jb     801045f0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
801045e1:	83 c4 20             	add    $0x20,%esp
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
    return -1;
...
80104645:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104648:	e8 53 f0 ff ff       	call   801036a0 <myproc>
...
8010465d:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
...
80104686:	c7 04 24 b1 75 10 80 	movl   $0x801075b1,(%esp)
...
801046b6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801046b9:	e8 e2 ef ff ff       	call   801036a0 <myproc>
...
8010470c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010470f:	e8 0c d8 ff ff       	call   80101f20 <nameiparent>
...
80104721:	e8 8a cf ff ff       	call   801016b0 <ilock>
...
8010476b:	e8 a0 d1 ff ff       	call   80101910 <iunlockput>
    panic("create: dirlink");
...
8010478d:	e8 8e cd ff ff       	call   80101520 <ialloc>
...
8010479f:	e8 0c cf ff ff       	call   801016b0 <ilock>
  ip->major = major;
...
801047c0:	e8 2b ce ff ff       	call   801015f0 <iupdate>
...
801047e6:	e8 25 d1 ff ff       	call   80101910 <iunlockput>
...
80104841:	79 89                	jns    801047cc <create+0xdc>
      panic("create dots");
80104843:	c7 04 24 4f 76 10 80 	movl   $0x8010764f,(%esp)
8010484a:	e8 11 bb ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010484f:	c7 04 24 5e 76 10 80 	movl   $0x8010765e,(%esp)
80104856:	e8 05 bb ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010485b:	c7 04 24 40 76 10 80 	movl   $0x80107640,(%esp)
...
80104899:	e8 02 ee ff ff       	call   801036a0 <myproc>
...
80104909:	e8 c2 c4 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104960:	e8 3b fc ff ff       	call   801045a0 <argptr>
...
8010497d:	e8 ae c5 ff ff       	call   80100f30 <fileread>
}
80104982:	c9                   	leave  
80104983:	c3                   	ret    
...
801049d0:	e8 cb fb ff ff       	call   801045a0 <argptr>
...
801049ed:	e8 de c5 ff ff       	call   80100fd0 <filewrite>
}
801049f2:	c9                   	leave  
801049f3:	c3                   	ret    
...
80104a13:	78 23                	js     80104a38 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104a15:	e8 86 ec ff ff       	call   801036a0 <myproc>
...
80104a2b:	e8 f0 c3 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104a6a:	e8 31 fb ff ff       	call   801045a0 <argptr>
...
80104a80:	e8 5b c4 ff ff       	call   80100ee0 <filestat>
}
80104a85:	c9                   	leave  
80104a86:	c3                   	ret    
80104a87:	90                   	nop
...
80104ac9:	0f 88 cb 00 00 00    	js     80104b9a <sys_link+0x10a>
  ...
  begin_op();
80104acf:	e8 3c e0 ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104ad4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104ad7:	89 04 24             	mov    %eax,(%esp)
80104ada:	e8 21 d4 ff ff       	call   80101f00 <namei>
...
80104aec:	e8 bf cb ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
...
80104b07:	e8 e4 ca ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104b0c:	89 1c 24             	mov    %ebx,(%esp)
80104b0f:	e8 7c cc ff ff       	call   80101790 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104b14:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b17:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b1b:	89 04 24             	mov    %eax,(%esp)
80104b1e:	e8 fd d3 ff ff       	call   80101f20 <nameiparent>
...
80104b45:	e8 d6 d2 ff ff       	call   80101e20 <dirlink>
...
80104b51:	e8 ba cd ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104b56:	89 1c 24             	mov    %ebx,(%esp)
80104b59:	e8 72 cc ff ff       	call   801017d0 <iput>

  end_op();
80104b5e:	e8 1d e0 ff ff       	call   80102b80 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104b73:	e8 98 cd ff ff       	call   80101910 <iunlockput>
  end_op();
...
80104b7b:	e8 30 cb ff ff       	call   801016b0 <ilock>
  ip->nlink--;
80104b80:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104b85:	89 1c 24             	mov    %ebx,(%esp)
80104b88:	e8 63 ca ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80104b8d:	89 1c 24             	mov    %ebx,(%esp)
80104b90:	e8 7b cd ff ff       	call   80101910 <iunlockput>
  end_op();
80104b95:	e8 e6 df ff ff       	call   80102b80 <end_op>
  return -1;
}
...
80104bce:	0f 88 76 01 00 00    	js     80104d4a <sys_unlink+0x19a>
  ...
  begin_op();
80104bd4:	e8 37 df ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104be6:	e8 35 d3 ff ff       	call   80101f20 <nameiparent>
...
80104c01:	c7 44 24 04 5c 76 10 	movl   $0x8010765c,0x4(%esp)
80104c08:	80 
80104c09:	89 1c 24             	mov    %ebx,(%esp)
80104c0c:	e8 7f cf ff ff       	call   80101b90 <namecmp>
80104c11:	85 c0                	test   %eax,%eax
80104c13:	0f 84 21 01 00 00    	je     80104d3a <sys_unlink+0x18a>
80104c19:	c7 44 24 04 5b 76 10 	movl   $0x8010765b,0x4(%esp)
80104c20:	80 
80104c21:	89 1c 24             	mov    %ebx,(%esp)
80104c24:	e8 67 cf ff ff       	call   80101b90 <namecmp>
...
80104c3f:	e8 7c cf ff ff       	call   80101bc0 <dirlookup>
...
80104c51:	e8 5a ca ff ff       	call   801016b0 <ilock>
...
80104c7e:	e8 fd f5 ff ff       	call   80104280 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104c9c:	e8 bf cd ff ff       	call   80101a60 <writei>
...
80104cbb:	e8 50 cc ff ff       	call   80101910 <iunlockput>
...
80104d21:	e8 3a cc ff ff       	call   80101960 <readi>
...
80104d35:	e8 d6 cb ff ff       	call   80101910 <iunlockput>
  end_op();
...
80104d63:	e8 88 c8 ff ff       	call   801015f0 <iupdate>
80104d68:	e9 48 ff ff ff       	jmp    80104cb5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104d6d:	c7 04 24 80 76 10 80 	movl   $0x80107680,(%esp)
80104d74:	e8 e7 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104d79:	c7 04 24 92 76 10 80 	movl   $0x80107692,(%esp)
80104d80:	e8 db b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104d85:	c7 04 24 6e 76 10 80 	movl   $0x8010766e,(%esp)
...
80104df4:	e8 07 d1 ff ff       	call   80101f00 <namei>
...
80104e16:	e8 45 bf ff ff       	call   80100d60 <filealloc>
...
80104e37:	e8 54 c9 ff ff       	call   80101790 <iunlock>
  end_op();
80104e3c:	e8 3f dd ff ff       	call   80102b80 <end_op>
...
80104e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    iunlockput(ip);
    end_op();
80104e90:	e8 eb dc ff ff       	call   80102b80 <end_op>
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
80104f1f:	e8 ec c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104f24:	e8 57 dc ff ff       	call   80102b80 <end_op>
  return 0;
...
80104f2d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
80104f30:	e8 4b dc ff ff       	call   80102b80 <end_op>
    return -1;
...
80104faf:	e8 5c c9 ff ff       	call   80101910 <iunlockput>
  end_op();
80104fb4:	e8 c7 db ff ff       	call   80102b80 <end_op>
  return 0;
...
80104fd5:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80104fd8:	e8 c3 e6 ff ff       	call   801036a0 <myproc>
80104fdd:	89 c6                	mov    %eax,%esi
  
  begin_op();
80104fdf:	e8 2c db ff ff       	call   80102b10 <begin_op>
...
80105001:	e8 fa ce ff ff       	call   80101f00 <namei>
...
8010500f:	e8 9c c6 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
8010501c:	75 22                	jne    80105040 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010501e:	e8 6d c7 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105023:	8b 46 6c             	mov    0x6c(%esi),%eax
80105026:	89 04 24             	mov    %eax,(%esp)
80105029:	e8 a2 c7 ff ff       	call   801017d0 <iput>
  end_op();
8010502e:	e8 4d db ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
...
801050cb:	e8 b0 f1 ff ff       	call   80104280 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
80105183:	e8 e8 df ff ff       	call   80103170 <pipealloc>
...
80105223:	e8 78 f3 ff ff       	call   801045a0 <argptr>
...
80105239:	e8 a2 1a 00 00       	call   80106ce0 <shm_open>
}
8010523e:	c9                   	leave  
8010523f:	c3                   	ret    
int sys_shm_open(void) {
...
80105273:	e8 f8 1b 00 00       	call   80106e70 <shm_close>
}
80105278:	c9                   	leave  
80105279:	c3                   	ret    
...
{
  return fork();
80105294:	e9 b7 e5 ff ff       	jmp    80103850 <fork>
...
801052a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801052a6:	e8 f5 e7 ff ff       	call   80103aa0 <exit>
...
801052e3:	e8 08 eb ff ff       	call   80103df0 <kill>
}
801052e8:	c9                   	leave  
801052e9:	c3                   	ret    
...
80105333:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80105336:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
80105339:	89 14 24             	mov    %edx,(%esp)
8010533c:	e8 9f e4 ff ff       	call   801037e0 <growproc>
80105341:	85 c0                	test   %eax,%eax
80105343:	78 0b                	js     80105350 <sys_sbrk+0x40>
    return -1;
  return addr;
80105345:	89 d8                	mov    %ebx,%eax
}
80105347:	83 c4 24             	add    $0x24,%esp
8010534a:	5b                   	pop    %ebx
8010534b:	5d                   	pop    %ebp
8010534c:	c3                   	ret    
...
80105355:	eb f0                	jmp    80105347 <sys_sbrk+0x37>
...
80105385:	e8 b6 ed ff ff       	call   80104140 <acquire>
  ticks0 = ticks;
...
801053d3:	e8 58 ee ff ff       	call   80104230 <release>
      return -1;
...
801053ef:	e8 3c ee ff ff       	call   80104230 <release>
  return 0;
}
...
801054b9:	c7 44 24 04 a1 76 10 	movl   $0x801076a1,0x4(%esp)
801054c0:	80 
...
801054e6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  ...
  initlock(&tickslock, "time");
801054ec:	e8 5f eb ff ff       	call   80104050 <initlock>
}
801054f1:	c9                   	leave  
801054f2:	c3                   	ret    
...
80105550:	ff 24 85 48 77 10 80 	jmp    *-0x7fef88b8(,%eax,4)
80105557:	90                   	nop
    lapiceoi();
    break;
...
801055ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801055b1:	83 c6 70             	add    $0x70,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
801055c0:	8b 40 14             	mov    0x14(%eax),%eax
801055c3:	c7 04 24 04 77 10 80 	movl   $0x80107704,(%esp)
...
801055d8:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
801055df:	90                   	nop
  }
...
801055ee:	8b 50 28             	mov    0x28(%eax),%edx
...
80105605:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105619:	8b 40 28             	mov    0x28(%eax),%eax
...
8010564b:	75 a8                	jne    801055f5 <trap+0xc5>
    exit();
8010564d:	e8 4e e4 ff ff       	call   80103aa0 <exit>
...
801056bc:	c7 04 24 ac 76 10 80 	movl   $0x801076ac,(%esp)
...
80105701:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105704:	e8 37 ef ff ff       	call   80104640 <syscall>
    if(myproc()->killed)
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105728:	e8 73 e3 ff ff       	call   80103aa0 <exit>
...
80105737:	e8 04 ea ff ff       	call   80104140 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105743:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010574a:	e8 41 e6 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010574f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105756:	e8 d5 ea ff ff       	call   80104230 <release>
...
8010577a:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
80105781:	89 44 24 04          	mov    %eax,0x4(%esp)
80105785:	e8 c6 ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010578a:	c7 04 24 a6 76 10 80 	movl   $0x801076a6,(%esp)
...
80105887:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105888:	bb c8 77 10 80       	mov    $0x801077c8,%ebx
...
801063b2:	e8 c9 de ff ff       	call   80104280 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106441:	e8 0a ff ff ff       	call   80106350 <walkpgdir>
    if(!pte)
...
8010646a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010646b:	c7 04 24 66 71 10 80 	movl   $0x80107166,(%esp)
...
8010652f:	c9                   	leave  
80106530:	c3                   	ret    
80106531:	eb 0d                	jmp    80106540 <mappages>
80106533:	90                   	nop
80106534:	90                   	nop
80106535:	90                   	nop
80106536:	90                   	nop
...
8010654c:	8b 55 10             	mov    0x10(%ebp),%edx
// Create PTEs for virtual addresses starting at va that refer to
// physical addresses starting at pa. va and size might not
// be page-aligned.
int
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
8010654f:	8b 7d 14             	mov    0x14(%ebp),%edi
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106552:	83 4d 18 01          	orl    $0x1,0x18(%ebp)
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
80106558:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010655e:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106562:	29 df                	sub    %ebx,%edi
80106564:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106567:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
...
80106573:	75 3d                	jne    801065b2 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106575:	0b 75 18             	or     0x18(%ebp),%esi
    if(a == last)
...
80106592:	e8 b9 fd ff ff       	call   80106350 <walkpgdir>
...
801065b1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801065b2:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
...
8010668d:	8b 56 0c             	mov    0xc(%esi),%edx
...
801066aa:	8b 46 08             	mov    0x8(%esi),%eax
...
801066bb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801066bc:	e9 ff da ff ff       	jmp    801041c0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
801066c1:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
801066c8:	e8 93 9c ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801066cd:	c7 04 24 01 78 10 80 	movl   $0x80107801,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801066d9:	c7 04 24 ec 77 10 80 	movl   $0x801077ec,(%esp)
...
801066f6:	83 ec 2c             	sub    $0x2c,%esp
...
80106708:	77 64                	ja     8010676e <inituvm+0x7e>
8010670a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
80106722:	89 04 24             	mov    %eax,(%esp)
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
80106725:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106727:	e8 54 db ff ff       	call   80104280 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010672c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010672f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106735:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010673c:	00 
8010673d:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106741:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106748:	00 
80106749:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106750:	00 
80106751:	89 14 24             	mov    %edx,(%esp)
80106754:	e8 e7 fd ff ff       	call   80106540 <mappages>
  memmove(mem, init, sz);
80106759:	89 75 10             	mov    %esi,0x10(%ebp)
8010675c:	89 7d 0c             	mov    %edi,0xc(%ebp)
8010675f:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106762:	83 c4 2c             	add    $0x2c,%esp
80106765:	5b                   	pop    %ebx
80106766:	5e                   	pop    %esi
80106767:	5f                   	pop    %edi
80106768:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106769:	e9 b2 db ff ff       	jmp    80104320 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
8010676e:	c7 04 24 15 78 10 80 	movl   $0x80107815,(%esp)
80106775:	e8 e6 9b ff ff       	call   80100360 <panic>
...
801067c3:	e8 88 fb ff ff       	call   80106350 <walkpgdir>
...
80106821:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106822:	c7 04 24 2f 78 10 80 	movl   $0x8010782f,(%esp)
80106829:	e8 32 9b ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010682e:	c7 04 24 d0 78 10 80 	movl   $0x801078d0,(%esp)
...
80106846:	83 ec 2c             	sub    $0x2c,%esp
...
8010684e:	0f 88 8f 00 00 00    	js     801068e3 <allocuvm+0xa3>
    return 0;
  if(newsz < oldsz)
...
80106857:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
8010685a:	0f 82 85 00 00 00    	jb     801068e5 <allocuvm+0xa5>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106860:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106866:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010686c:	39 df                	cmp    %ebx,%edi
8010686e:	77 57                	ja     801068c7 <allocuvm+0x87>
80106870:	eb 7e                	jmp    801068f0 <allocuvm+0xb0>
...
8010688b:	e8 f0 d9 ff ff       	call   80104280 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106890:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106896:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010689a:	8b 45 08             	mov    0x8(%ebp),%eax
8010689d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801068a4:	00 
801068a5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801068ac:	00 
801068ad:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801068b1:	89 04 24             	mov    %eax,(%esp)
801068b4:	e8 87 fc ff ff       	call   80106540 <mappages>
801068b9:	85 c0                	test   %eax,%eax
801068bb:	78 43                	js     80106900 <allocuvm+0xc0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801068bd:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068c3:	39 df                	cmp    %ebx,%edi
801068c5:	76 29                	jbe    801068f0 <allocuvm+0xb0>
    mem = kalloc();
801068c7:	e8 d4 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
801068cc:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
801068ce:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801068d0:	75 a6                	jne    80106878 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
801068d2:	c7 04 24 4d 78 10 80 	movl   $0x8010784d,(%esp)
801068d9:	e8 72 9d ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
801068de:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801068e1:	77 47                	ja     8010692a <allocuvm+0xea>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
...
801068e5:	83 c4 2c             	add    $0x2c,%esp
801068e8:	5b                   	pop    %ebx
801068e9:	5e                   	pop    %esi
801068ea:	5f                   	pop    %edi
801068eb:	5d                   	pop    %ebp
...
801068f0:	83 c4 2c             	add    $0x2c,%esp
...
801068fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106900:	c7 04 24 65 78 10 80 	movl   $0x80107865,(%esp)
...
8010690f:	76 0d                	jbe    8010691e <allocuvm+0xde>
80106911:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106914:	89 fa                	mov    %edi,%edx
80106916:	8b 45 08             	mov    0x8(%ebp),%eax
80106919:	e8 c2 fa ff ff       	call   801063e0 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106921:	e8 ca b9 ff ff       	call   801022f0 <kfree>
      return 0;
80106926:	31 c0                	xor    %eax,%eax
80106928:	eb bb                	jmp    801068e5 <allocuvm+0xa5>
8010692a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010692d:	89 fa                	mov    %edi,%edx
8010692f:	8b 45 08             	mov    0x8(%ebp),%eax
80106932:	e8 a9 fa ff ff       	call   801063e0 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106939:	eb aa                	jmp    801068e5 <allocuvm+0xa5>
8010693b:	90                   	nop
...
80106950:	5d                   	pop    %ebp
80106951:	e9 8a fa ff ff       	jmp    801063e0 <deallocuvm.part.0>
...
8010697a:	e8 61 fa ff ff       	call   801063e0 <deallocuvm.part.0>
...
801069ad:	e8 3e b9 ff ff       	call   801022f0 <kfree>
  uint i;
...
801069c2:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
801069c3:	e9 28 b9 ff ff       	jmp    801022f0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
801069c8:	c7 04 24 81 78 10 80 	movl   $0x80107881,(%esp)
...
801069e8:	e8 b3 ba ff ff       	call   801024a0 <kalloc>
801069ed:	85 c0                	test   %eax,%eax
801069ef:	89 c6                	mov    %eax,%esi
801069f1:	74 75                	je     80106a68 <setupkvm+0x88>
    return 0;
...
80106a0b:	e8 70 d8 ff ff       	call   80104280 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106a16:	89 34 24             	mov    %esi,(%esp)
80106a19:	89 54 24 10          	mov    %edx,0x10(%esp)
80106a1d:	8b 53 08             	mov    0x8(%ebx),%edx
80106a20:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106a24:	29 c2                	sub    %eax,%edx
80106a26:	8b 03                	mov    (%ebx),%eax
80106a28:	89 54 24 08          	mov    %edx,0x8(%esp)
80106a2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a30:	e8 0b fb ff ff       	call   80106540 <mappages>
80106a35:	85 c0                	test   %eax,%eax
80106a37:	78 17                	js     80106a50 <setupkvm+0x70>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106a39:	83 c3 10             	add    $0x10,%ebx
80106a3c:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106a42:	72 cc                	jb     80106a10 <setupkvm+0x30>
...
80106a46:	83 c4 20             	add    $0x20,%esp
80106a49:	5b                   	pop    %ebx
80106a4a:	5e                   	pop    %esi
80106a4b:	5d                   	pop    %ebp
80106a4c:	c3                   	ret    
80106a4d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80106a50:	89 34 24             	mov    %esi,(%esp)
80106a53:	e8 08 ff ff ff       	call   80106960 <freevm>
      return 0;
    }
  return pgdir;
}
...
80106a6a:	eb da                	jmp    80106a46 <setupkvm+0x66>
...
80106a7b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106a9e:	e8 ad f8 ff ff       	call   80106350 <walkpgdir>
  if(pte == 0)
...
80106aab:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106aac:	c7 04 24 92 78 10 80 	movl   $0x80107892,(%esp)
...
80106ad3:	0f 84 ba 00 00 00    	je     80106b93 <copyuvm+0xd3>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ad9:	8b 45 0c             	mov    0xc(%ebp),%eax
80106adc:	85 c0                	test   %eax,%eax
80106ade:	0f 84 a4 00 00 00    	je     80106b88 <copyuvm+0xc8>
80106ae4:	31 db                	xor    %ebx,%ebx
80106ae6:	eb 51                	jmp    80106b39 <copyuvm+0x79>
...
80106afd:	e8 1e d8 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106b02:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b05:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106b0b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106b0f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b16:	00 
80106b17:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106b1b:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b1f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b22:	89 04 24             	mov    %eax,(%esp)
80106b25:	e8 16 fa ff ff       	call   80106540 <mappages>
80106b2a:	85 c0                	test   %eax,%eax
80106b2c:	78 45                	js     80106b73 <copyuvm+0xb3>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b2e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b34:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106b37:	76 4f                	jbe    80106b88 <copyuvm+0xc8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106b39:	8b 45 08             	mov    0x8(%ebp),%eax
80106b3c:	31 c9                	xor    %ecx,%ecx
80106b3e:	89 da                	mov    %ebx,%edx
80106b40:	e8 0b f8 ff ff       	call   80106350 <walkpgdir>
80106b45:	85 c0                	test   %eax,%eax
80106b47:	74 5a                	je     80106ba3 <copyuvm+0xe3>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106b49:	8b 30                	mov    (%eax),%esi
80106b4b:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b51:	74 44                	je     80106b97 <copyuvm+0xd7>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b53:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106b55:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106b5b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b5e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106b64:	e8 37 b9 ff ff       	call   801024a0 <kalloc>
80106b69:	85 c0                	test   %eax,%eax
80106b6b:	89 c6                	mov    %eax,%esi
80106b6d:	0f 85 75 ff ff ff    	jne    80106ae8 <copyuvm+0x28>
      goto bad;
}
   return d;
...
bad:
  freevm(d);
80106b73:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b76:	89 04 24             	mov    %eax,(%esp)
80106b79:	e8 e2 fd ff ff       	call   80106960 <freevm>
  return 0;
80106b7e:	31 c0                	xor    %eax,%eax
}
80106b80:	83 c4 2c             	add    $0x2c,%esp
80106b83:	5b                   	pop    %ebx
80106b84:	5e                   	pop    %esi
80106b85:	5f                   	pop    %edi
80106b86:	5d                   	pop    %ebp
...
80106b95:	eb e9                	jmp    80106b80 <copyuvm+0xc0>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106b97:	c7 04 24 b6 78 10 80 	movl   $0x801078b6,(%esp)
80106b9e:	e8 bd 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106ba3:	c7 04 24 9c 78 10 80 	movl   $0x8010789c,(%esp)
80106baa:	e8 b1 97 ff ff       	call   80100360 <panic>
80106baf:	90                   	nop
...
80106bbe:	e8 8d f7 ff ff       	call   80106350 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106c2c:	e8 ef d6 ff ff       	call   80104320 <memmove>
    len -= n;
    buf += n;
...
80106c86:	c7 44 24 04 f4 78 10 	movl   $0x801078f4,0x4(%esp)
80106c8d:	80 
80106c8e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106c95:	e8 b6 d3 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106c9a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106ca1:	e8 9a d4 ff ff       	call   80104140 <acquire>
80106ca6:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106cab:	90                   	nop
80106cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106cb0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106cb6:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106cb9:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106cc0:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106cc7:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106ccc:	75 e2                	jne    80106cb0 <shminit+0x30>
    shm_table.shm_pages[i].id =0;
    shm_table.shm_pages[i].frame =0;
    shm_table.shm_pages[i].refcnt =0;
  }
...
80106cd5:	e8 56 d5 ff ff       	call   80104230 <release>
}
80106cda:	c9                   	leave  
80106cdb:	c3                   	ret    
...
int shm_open(int id, char **pointer) {
80106cea:	83 ec 2c             	sub    $0x2c,%esp
...
80106cf0:	e8 ab c9 ff ff       	call   801036a0 <myproc>
80106cf5:	8b 40 04             	mov    0x4(%eax),%eax
acquire(&(shm_table.lock));
80106cf8:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
//you write thisi
uint addre = 0;
int found = 0;
int i,fr = 0;
...
uint va = PGROUNDUP(myproc()->sz);
80106cff:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d04:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d07:	81 65 e0 00 f0 ff ff 	andl   $0xfffff000,-0x20(%ebp)
acquire(&(shm_table.lock));
80106d0e:	e8 2d d4 ff ff       	call   80104140 <acquire>
80106d13:	b8 f4 55 11 80       	mov    $0x801155f4,%eax

for (i = 0; i< 64; i++) {
80106d18:	31 d2                	xor    %edx,%edx
}
...
80106d21:	eb 18                	jmp    80106d3b <shm_open+0x5b>
80106d23:	90                   	nop
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106d28:	8b 48 08             	mov    0x8(%eax),%ecx
80106d2b:	85 c9                	test   %ecx,%ecx
80106d2d:	0f 44 da             	cmove  %edx,%ebx
int i,fr = 0;
...
80106d39:	74 28                	je     80106d63 <shm_open+0x83>
   if(shm_table.shm_pages[i].id == id){
80106d3b:	39 30                	cmp    %esi,(%eax)
80106d3d:	75 e9                	jne    80106d28 <shm_open+0x48>
    addre = (uint) shm_table.shm_pages[i].frame;
80106d3f:	8b 78 04             	mov    0x4(%eax),%edi
80106d42:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    shm_table.shm_pages[i].refcnt = shm_table.shm_pages[i].refcnt+1 ;
80106d45:	8b 78 08             	mov    0x8(%eax),%edi
80106d48:	8d 4f 01             	lea    0x1(%edi),%ecx
    found = 1;
80106d4b:	bf 01 00 00 00       	mov    $0x1,%edi
80106d50:	85 c9                	test   %ecx,%ecx
80106d52:	0f 44 da             	cmove  %edx,%ebx
int i,fr = 0;
...
for (i = 0; i< 64; i++) {
80106d55:	83 c2 01             	add    $0x1,%edx
   if(shm_table.shm_pages[i].id == id){
    addre = (uint) shm_table.shm_pages[i].frame;
    shm_table.shm_pages[i].refcnt = shm_table.shm_pages[i].refcnt+1 ;
80106d58:	89 48 08             	mov    %ecx,0x8(%eax)
80106d5b:	83 c0 0c             	add    $0xc,%eax
int i,fr = 0;
...
for (i = 0; i< 64; i++) {
80106d5e:	83 fa 40             	cmp    $0x40,%edx
80106d61:	75 d8                	jne    80106d3b <shm_open+0x5b>
    found = 1;
...
release(&(shm_table.lock));
80106d63:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d6a:	e8 c1 d4 ff ff       	call   80104230 <release>
if(found){
80106d6f:	85 ff                	test   %edi,%edi
80106d71:	74 6a                	je     80106ddd <shm_open+0xfd>
   if( mappages(myproc()->pgdir,(void*) va ,PGSIZE,V2P( addre ), PTE_W | PTE_U ) != 0)
80106d73:	e8 28 c9 ff ff       	call   801036a0 <myproc>
80106d78:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d7b:	8b 75 e0             	mov    -0x20(%ebp),%esi
80106d7e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d85:	00 
80106d86:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d8d:	00 
80106d8e:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106d94:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106d98:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d9c:	8b 40 08             	mov    0x8(%eax),%eax
80106d9f:	89 04 24             	mov    %eax,(%esp)
80106da2:	e8 99 f7 ff ff       	call   80106540 <mappages>
80106da7:	85 c0                	test   %eax,%eax
80106da9:	0f 85 b4 00 00 00    	jne    80106e63 <shm_open+0x183>
      panic("mmpages error");
    
    *pointer = (char*) myproc()->sz;
80106daf:	e8 ec c8 ff ff       	call   801036a0 <myproc>
80106db4:	8b 75 0c             	mov    0xc(%ebp),%esi
80106db7:	8b 40 04             	mov    0x4(%eax),%eax
80106dba:	89 06                	mov    %eax,(%esi)
...
80106dbc:	e8 df c8 ff ff       	call   801036a0 <myproc>
80106dc1:	89 c3                	mov    %eax,%ebx
80106dc3:	e8 d8 c8 ff ff       	call   801036a0 <myproc>
80106dc8:	8b 40 04             	mov    0x4(%eax),%eax
80106dcb:	05 00 10 00 00       	add    $0x1000,%eax
80106dd0:	89 43 04             	mov    %eax,0x4(%ebx)
}
...
80106ddd:	8d 1c 5b             	lea    (%ebx,%ebx,2),%ebx
80106de0:	c1 e3 02             	shl    $0x2,%ebx
80106de3:	89 b3 f4 55 11 80    	mov    %esi,-0x7feeaa0c(%ebx)
    shm_table.shm_pages[fr].frame = kalloc();
80106de9:	e8 b2 b6 ff ff       	call   801024a0 <kalloc>
memset(shm_table.shm_pages[fr].frame, 0, PGSIZE);   
...
80106dfe:	89 04 24             	mov    %eax,(%esp)
    ...
    *pointer = (char*) myproc()->sz;
    ...
    shm_table.shm_pages[fr].id = id;
    shm_table.shm_pages[fr].frame = kalloc();
80106e01:	89 83 f8 55 11 80    	mov    %eax,-0x7feeaa08(%ebx)
memset(shm_table.shm_pages[fr].frame, 0, PGSIZE);   
80106e07:	e8 74 d4 ff ff       	call   80104280 <memset>
 if( mappages(myproc()->pgdir,(void*) va,PGSIZE,V2P( shm_table.shm_pages[fr].frame ), PTE_W | PTE_U ) != 0)
80106e0c:	8b b3 f8 55 11 80    	mov    -0x7feeaa08(%ebx),%esi
80106e12:	e8 89 c8 ff ff       	call   801036a0 <myproc>
80106e17:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e1e:	00 
80106e1f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e26:	00 
80106e27:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106e2d:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106e31:	8b 75 e0             	mov    -0x20(%ebp),%esi
80106e34:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e38:	8b 40 08             	mov    0x8(%eax),%eax
80106e3b:	89 04 24             	mov    %eax,(%esp)
80106e3e:	e8 fd f6 ff ff       	call   80106540 <mappages>
80106e43:	85 c0                	test   %eax,%eax
80106e45:	75 1c                	jne    80106e63 <shm_open+0x183>
      panic("mmpages error");
    shm_table.shm_pages[fr].refcnt =1;
80106e47:	c7 83 fc 55 11 80 01 	movl   $0x1,-0x7feeaa04(%ebx)
80106e4e:	00 00 00 
    *pointer = (char*) myproc()->sz;
80106e51:	e8 4a c8 ff ff       	call   801036a0 <myproc>
80106e56:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80106e59:	8b 40 04             	mov    0x4(%eax),%eax
80106e5c:	89 03                	mov    %eax,(%ebx)
80106e5e:	e9 59 ff ff ff       	jmp    80106dbc <shm_open+0xdc>
    }
}
release(&(shm_table.lock));
if(found){
   if( mappages(myproc()->pgdir,(void*) va ,PGSIZE,V2P( addre ), PTE_W | PTE_U ) != 0)
      panic("mmpages error");
80106e63:	c7 04 24 fd 78 10 80 	movl   $0x801078fd,(%esp)
...
int i;
acquire(&(shm_table.lock));
80106e7a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e81:	e8 ba d2 ff ff       	call   80104140 <acquire>
80106e86:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106e8b:	eb 13                	jmp    80106ea0 <shm_close+0x30>
80106e8d:	8d 76 00             	lea    0x0(%esi),%esi
   if( shm_table.shm_pages[i].id == id && shm_table.shm_pages[i].refcnt ==1 ){
       ...
       shm_table.shm_pages[i].refcnt=  shm_table.shm_pages[i].refcnt -1;
80106e90:	83 ea 01             	sub    $0x1,%edx
80106e93:	83 c0 0c             	add    $0xc,%eax
80106e96:	89 50 fc             	mov    %edx,-0x4(%eax)
...
acquire(&(shm_table.lock));
for (i = 0; i< 64; i++) {
80106e99:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106e9e:	74 30                	je     80106ed0 <shm_close+0x60>
   if( shm_table.shm_pages[i].id == id && shm_table.shm_pages[i].refcnt ==1 ){
80106ea0:	3b 18                	cmp    (%eax),%ebx
80106ea2:	8b 50 08             	mov    0x8(%eax),%edx
80106ea5:	75 e9                	jne    80106e90 <shm_close+0x20>
80106ea7:	83 fa 01             	cmp    $0x1,%edx
80106eaa:	75 e4                	jne    80106e90 <shm_close+0x20>
       shm_table.shm_pages[i].id =0;
80106eac:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106eb2:	83 c0 0c             	add    $0xc,%eax
       shm_table.shm_pages[i].frame =0;
80106eb5:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
       shm_table.shm_pages[i].refcnt =0;
80106ebc:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
acquire(&(shm_table.lock));
for (i = 0; i< 64; i++) {
80106ec3:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106ec8:	75 d6                	jne    80106ea0 <shm_close+0x30>
...
release(&(shm_table.lock));
80106ed0:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106ed7:	e8 54 d3 ff ff       	call   80104230 <release>
return 0; //added to remove compiler warning -- you should decide what to return
}
80106edc:	83 c4 14             	add    $0x14,%esp
